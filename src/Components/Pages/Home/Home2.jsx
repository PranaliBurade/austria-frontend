...
function Home2() {
  ...
  return (
    <>
    <div className='container-fluid bg-dark12 divcol1 p-5'>
        <h3 className='text-start ms-md-5 mb-5 text-primary astmobil'>Why AstroFroge.ai ?</h3>
    ...
    <div className='col-12 col-sm-6 col-md-12 col-lg-5 col-xl-5 col-xxl-6 '>
       ...
       <ul className='list-unstyled padend pt-4'>
        <li className='text-justify text-light mb-3'><i class="bi bi-gear-wide-connected fs-6 me-2 text-primary"></i>Traditional automation frameworks require manual test design, locator maintenance, and time-consuming configuration.</li>
        <li className='text-justify text-light'><i class="bi bi-gear-wide-connected fs-6 me-2 text-primary"></i>AstroFroge.ai brings intelligence, adaptability, and automation together — making your testing lifecycle self-aware, self-healing, and continuously improving.</li>
       </ul>
        </div>
    </div>
