    ...
    <div className=' container-fluid divcol1 text-light '>
        {/* <div className='row m-5'>
            <div className='col-12 col-md-7 col-lg-7'>
                <h1 className='text-cente pt-4'>Seamlessly integrate <span className='gradient-text '>Astraforge.ai</span> into your setup</h1>
                <p className='padd'>We work with the tools and frameworks you use. Test development code from Visual Studio and non-production apps from Firebase. Run automated tests on every commit from your CI/CD pipeline, and get test results directly in Jenkins and Slack. Report bugs directly to Jira, and reproduce them with a click.</p>
            </div>
            <div className='col-12 col-md-5 col-lg-5'>
                <img data-src="https://ninjapromo.io/wp-content/uploads/2024/11/about-bg.svg" alt="" src="https://ninjapromo.io/wp-content/uploads/2024/11/about-bg.svg" className="inti-section__img"></img>
            </div>
        </div> */}
